...
module tb_comprehensive;
    ...
    initial begin
        ...
        // MOV_LIT preserves the upper bits of rd and replaces the low 12 bits.
        clear_program();
        ...
        run_until_halt(60);
        expect64("mov_lit preserves upper bits", dut.reg_file.registers[5], 64'h1234_5678_9abc_d123);
